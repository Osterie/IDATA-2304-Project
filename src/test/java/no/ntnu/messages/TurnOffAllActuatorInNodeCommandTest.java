...
import no.ntnu.messages.commands.TurnOffAllActuatorInNodeCommand;
...
public class TurnOffAllActuatorInNodeCommandTest {
    ...
    public void testExecute() {
        ...
        assertEquals("TURN_OFF_ALL_ACTUATORS_SUCCESS", result.getBody().getData());
        assertEquals("TURN_OFF_ALL_ACTUATORS", result.getHeader().getDataType());
    }

    @Test
    public void testToProtocolString() {
        assertEquals("TURN_OFF_ALL_ACTUATORS", command.toProtocolString());
    }
}