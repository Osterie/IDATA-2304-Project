...
/**
 * Custom exception thrown when an identification message provided by a client
 * is invalid.
 * This can occur when the message does not meet the expected format or contains
 * unrecognized identifiers.
 */
public class InvalidIdentificationException extends RuntimeException {

  /**
   * Constructs a new InvalidIdentificationException with the specified detail
   * message.
   *
