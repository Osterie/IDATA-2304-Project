...
public class ActuatorFactory {
  ...
  public static Actuator createWindow(int nodeId) {
    Actuator actuator =
        new Actuator(ACTUATOR_INFO_WINDOW.getType(), nodeId, ACTUATOR_INFO_WINDOW.getTurnOnText(),
  ...
  public static Actuator createFan(int nodeId) {
    Actuator actuator =
        new Actuator(ACTUATOR_INFO_FAN.getType(), nodeId, ACTUATOR_INFO_FAN.getTurnOnText(),
  ...
  public static Actuator createHeater(int nodeId) {
    Actuator actuator =
        new Actuator(ACTUATOR_INFO_HEATER.getType(), nodeId, ACTUATOR_INFO_HEATER.getTurnOnText(),
  ...
  public static Actuator createLight(int nodeId) {
    Actuator actuator =
        new Actuator(ACTUATOR_INFO_LIGHT.getType(), nodeId, ACTUATOR_INFO_LIGHT.getTurnOnText(),
