...
public class ActuatorFactory {
    ...
    public static Actuator createWindow(int nodeId) {
        Actuator actuator = new Actuator(ACTUATOR_INFO_WINDOW.getType(), nodeId, ACTUATOR_INFO_WINDOW.getTurnOnText(),
                ACTUATOR_INFO_WINDOW.getTurnOffText());
    ...
    public static Actuator createFan(int nodeId) {
        Actuator actuator = new Actuator(ACTUATOR_INFO_FAN.getType(), nodeId, ACTUATOR_INFO_FAN.getTurnOnText(),
                ACTUATOR_INFO_FAN.getTurnOffText());
    ...
    public static Actuator createHeater(int nodeId) {
        Actuator actuator = new Actuator(ACTUATOR_INFO_HEATER.getType(), nodeId, ACTUATOR_INFO_HEATER.getTurnOnText(),
                ACTUATOR_INFO_HEATER.getTurnOffText());
    ...
    public static Actuator createLight(int nodeId) {
        Actuator actuator = new Actuator(ACTUATOR_INFO_LIGHT.getType(), nodeId, ACTUATOR_INFO_LIGHT.getTurnOnText(),
                ACTUATOR_INFO_LIGHT.getTurnOffText());
