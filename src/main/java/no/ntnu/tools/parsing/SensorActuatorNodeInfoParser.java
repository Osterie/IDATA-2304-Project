...
/**
 * Utility class for parsing specifications to create SensorActuatorNodeInfo objects.
 *
 ...
 * The specification string contains details about the sensor-actuator nodes and their actuators.
 *
 * <p>Key functionalities:
 * <ul>
 *     <li>Parse node ID and actuator details from a structured string format.</li>
 *     <li>Create and configure {@link Actuator} objects based on the specification.</li>
 *     <li>Support integration with {@link ActuatorListener} for actuator events.</li>
 * </ul>
 *
 * <p>The specification string format is expected to adhere to the following structure:<ul>
 *
 *     <li><b>Node specification:</b> [node_id][delimiter][actuator_specifications]</li>
 *     <li><b>Actuator specification:</b> [type]_[id]_[on_text]_[off_text]_[state]</li>
 * </ul>
 *
 * <p>Example specification:
 * <pre>"1;temperature_101_ON_OFF_true;humidity_102_START_STOP_false"</pre>
 *
 * <p>This would create a {@link SensorActuatorNodeInfo} object with ID 1 and two actuators:
 * <ul>
 *     <li>Actuator of type "temperature" with ID 101, turned on, with texts "ON" and "OFF".</li>
 *     <li>Actuator of type "humidity" with ID 102, turned off, with texts "START" and "STOP".</li>
 * </ul>
 *
 * <h3>Exceptions:</h3>
 * <ul>
 *     <li>{@link IllegalArgumentException} is thrown for invalid or malformed specifications.</li>
 * </ul>
 *
...
public class SensorActuatorNodeInfoParser {
  ...
  private static void parseActuatorInfo(String s,
    ...
    Actuator actuator = new Actuator(actuatorId, actuatorType,
            info.getId(), turnOnText, turnOffText);
