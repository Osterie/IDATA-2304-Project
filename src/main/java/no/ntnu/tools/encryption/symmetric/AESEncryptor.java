 ...
 *
 * <p>AES (Advanced Encryption Standard) is a symmetric encryption algorithm widely used for securing data.</p>
 *
 * <h3>Features:</h3>
 * <ul>
...
public class AESEncryptor {
     ...
     *
     * <p>This method creates a random 128-bit AES secret key that can be used for encryption and decryption.</p>
     *
     ...
     *
     * <p>This method takes an encrypted message in Base64 format and decrypts it using the provided AES secret key.
