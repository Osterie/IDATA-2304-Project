 ...
 * <ul>
 *   <li>{@link #SensorPane(Iterable)}: Constructs a new SensorPane with the title "Sensors"
 *   and initializes it with the provided sensor readings.</li>
 *   <li>{@link #SensorPane()}: Constructs a new SensorPane with the title "Sensors"
 *   without initializing it with sensor readings.</li>
 * </ul>
 *
 * <p>The class also provides the following methods:
 * <ul>
 *   <li>{@link #initialize(Iterable)}: Initializes the SensorPane with the
 *   provided sensor readings.</li>
 *   <li>{@link #update(Iterable)}: Updates the SensorPane by clearing the
 *   current components and reinitializing them with the provided sensor readings.</li>
 * </ul>
 *
...
public class SensorPane extends BasePane {
   ...
   * For each sensor in the collection, a corresponding UI
   * component is created and added to the pane.
   */
   ...
   * For each sensor in the collection, a corresponding
   * UI component is created and added to the pane.
   *
