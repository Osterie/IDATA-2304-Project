 ...
 * This response indicates that the associated transmission was executed successfully.
 */
public class SuccessResponse extends Response {

  /**
   * Constructs a {@code SuccessResponse} with the specified transmission and response data.
   *
   * @param transmission      The {@link Transmission} associated with this success response.
