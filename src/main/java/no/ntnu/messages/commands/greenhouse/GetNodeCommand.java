...
/**
 * Represents a command to retrieve information about a node in the greenhouse
 * system.
 * This command is sent to a greenhouse node to request details about its
 * actuators and state.
 */
public class GetNodeCommand extends GreenhouseCommand {
    ...
    /**
     * Executes the "GET_NODE" command on a given greenhouse node's logic and
     * returns a response message.
     * This method gathers information about the node's actuators and their state,
     * formats it,
     * and includes it in a response message.
     *
     * @param nodeLogic  The {@link NodeLogic} instance representing the logic of
     *                   the greenhouse node.
     * @param fromHeader The {@link MessageHeader} of the message that initiated
     *                   this command.
